...
class sand_dunes(colorTheme):
    ...
    node_selected_color = "#64b5c1"
    node_grid_alt_lines_color = "#c49c6a"
...
class chili_pepper(colorTheme):
    ...
    node_socket_event_color = "#968080"
    node_socket_boolean_color = "#2f3aa3"
    node_wire_error_color = "#D6858A"
    
    node_outliner_label_0 = "#FFD1BA"
    node_outliner_label_1 = "#493657"
    node_outliner_label_2 = "#FFD1BA"
    node_outliner_label_3 = "#A4AF69"
