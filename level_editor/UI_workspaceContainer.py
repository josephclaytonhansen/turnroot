...
tiles = {0:{}, 1:{}, 2:{}, 3:{}, 4:{}, 5:{}, 6:{}}
ttype = ""
tile_set = "ple_grass_dirt_and_water"
ttype_label = None
ttype_pix = None
ttype_img = None
p_ttype_pix = None
...
class TilesInfo(QWidget):
    def __init__(self):
        ...
        self.active_theme = getattr(UI_colorTheme, data["active_theme"])
        p_ttype_label.setStyleSheet("font-size: "+str(data["font_size"]-2)+"px; background-color: "+self.active_theme.window_background_color+";color: "+self.active_theme.window_text_color)
        ttype_label.setStyleSheet("font-size: "+str(data["font_size"]-2)+"px; background-color: "+self.active_theme.window_background_color+";color: "+self.active_theme.window_text_color)
        ...
        pr_label.setStyleSheet("font-size: "+str(data["font_size"]-2)+"px; background-color: "+self.active_theme.window_background_color+";color: "+self.active_theme.window_text_color)
...
class Tiles(QWidget):
    def __init__(self):
        ...
        self.pixmap = QPixmap("tiles/"+tile_set+".png")
